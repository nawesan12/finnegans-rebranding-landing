  ...
  return (
    <>
      ...
      <section className="bg-[#008584] flex flex-col lg:flex-row items-center justify-evenly lg:h-96 py-11 px-8 lg:py-0 gap-11 lg:gap-0 relative z-40">
        ...
        <motion.p
          className="lg:max-w-sm text-2xl text-center lg:text-left"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7, delay: 0.2 }}
          viewport={{ once: true }}
        >
          Impulsamos el aprendizaje y <br className="lg:block hidden" />{" "}
          desarrollo de quienes <br className="lg:block hidden" />
          usan nuestra tecnologia.
        </motion.p>
      ...
      <section className="section-purple bg-[#8694ff] py-20 lg:py-26 relative z-40">
        <div className="container mx-auto px-6 text-center">
          <motion.div
            className="mx-auto max-w-7xl text-4xl poppins-regular leading-tight text-white md:text-4xl"
          ...
          >
            ...
            <div className="inline-flex relative max-w-max">
              ...
              <motion.img
                ...
                alt=""
                className="object-contain w-full absolute z-10 -bottom-2 -scale-[30%] rotate-180 right-4"
                initial={{ opacity: 0, scale: 0.8 }}
                whileInView={{ opacity: 1, scale: 1 }}
            ...
            <div className="inline-flex relative max-w-max">
              ...
              <motion.img
                ...
                alt=""
                className="object-contain w-10 absolute z-10 -top-1 right-8"
