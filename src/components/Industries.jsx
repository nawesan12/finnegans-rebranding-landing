...
export default function App() {
  return (
    <section
      id="soluciones"
      className="w-full md:h-auto max-h-svh py-10 bg-[#020e33] overflow-x-hidden relative"
    >
      <div className="lg:max-w-7xl mx-auto lg:px-0 flex flex-col items-center justify-center gap-20 lg:grid lg:grid-cols-3 lg:gap-16">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="text-5xl  lg:text-7xl whitespace-nowrap  leading-none py-16 pb-64 md:py-0 md:poppins-medium ">
        ...
        <motion.video
          ...
          style={{ maxWidth: "800px" }}
          className="lg:hidden lg:h-full w-full max-w-full max-h-screen object-cover col-span-2 lg:scale-110 md:top-0 top-72 absolute md:relative lg:left-10 md:scale-110 block md:hidden"
          initial={{ opacity: 0, scale: 0.9, y: 40 }}
          whileInView={{ opacity: 1, scale: 1, y: 0 }}
          transition={{ duration: 1, ease: "easeOut", delay: 0.4 }}
          viewport={{ once: true }}
